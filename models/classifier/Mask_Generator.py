...
class RandomRectangleMaskEmbedder:
    def __init__(self, margin=10, bbox_min_size=30, bbox_max_size=200, min_times=1, max_times=3, ramp_kwargs=None):
        self.margin = margin
...
class OutpaintingMaskEmbedder:
    def __init__(self, min_padding_percent:float=0.04, max_padding_percent:int=0.8, left_padding_prob:float=0.5, top_padding_prob:float=0.5, 
...
class MixedMaskEmbedder:
    def __init__(self, irregular_proba=0.5, irregular_kwargs=None,
                 box_proba=0.5, box_kwargs=None,
                 full_proba=0, full_kwargs=None,
        ...
        if irregular_kwargs is None:
            irregular_kwargs = {'max_angle': 4, 'max_len': 50, 'max_width': 80, 'min_len': 50, 'min_width': 30, 'min_times': 1, 'max_times': 5}
        else:
        ...
        if box_kwargs is None:
            box_kwargs = {'margin': 10, 'bbox_min_size': 100, 'bbox_max_size': 150, 'min_times': 1, 'max_times': 3}
        else:
